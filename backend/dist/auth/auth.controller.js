...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Token de acceso generado' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 403, description: 'No autorizado (requiere rol admin)' }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)('admin'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Actualizar rol de usuario (solo admin)' }),
