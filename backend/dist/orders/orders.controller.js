...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Listar todos los pedidos (solo admin)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Obtener pedidos de un usuario' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Pedidos del usuario' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener detalles de un pedido' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Detalles del pedido' }),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)('admin'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Actualizar estado del pedido (solo admin)' }),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)('admin'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Actualizar estado de pago (solo admin)' }),
